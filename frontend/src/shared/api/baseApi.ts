...
export const baseApi = createApi({
  ...
  tagTypes: ['Me', 'Book', 'VendorBook', 'Categories', 'Cart', 'Order', 'Ebook', 'OwnedBooks', 'Wishlist', 'Review', 'VendorCoupon', 'VendorOrder', 'AdminUser', 'AdminVendor', 'AdminOrder', 'AdminProduct', 'Notification', 'Analytics', 'Wallet', 'BankAccount', 'CommissionSetting'],
  endpoints: () => ({}),
});
